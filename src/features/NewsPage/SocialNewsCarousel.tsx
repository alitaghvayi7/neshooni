...
function SocialNewsSlider({ data }: { data: SingleNews[] | [] }) {
    ...
    <div className="flex h-full w-full flex-col gap-6 lg:flex-row">
      <div className="relative mx-auto h-[249px] w-full lg:h-[429px] lg:w-1/2">
        <div className="absolute top-[35%] z-10 w-full lg:top-[40%]">
          <div className="clippath1 absolute right-[-1px] top-[-27px] h-10 w-10 bg-[#F5F8FF]"></div>
          <div className="clippath1 swiper-rotate1 absolute right-[-1px] top-[69px] h-10 w-10 bg-[#F5F8FF]"></div>
          <div className="clippath1 swiper-rotate2 absolute left-[-1px] top-[-27px] h-10 w-10 bg-[#F5F8FF]"></div>
          <div className="clippath1 absolute left-[-1px] top-[4.2rem] h-10 w-10 rotate-180 bg-[#F5F8FF]"></div>
          <div className="absolute right-[-40px] flex h-20 w-20 items-center justify-center rounded-full bg-[#F5F8FF]">
          ...
          <div className="absolute left-[-40px] flex h-20 w-20 items-center justify-center rounded-full bg-[#F5F8FF]">
            <div className="flex h-12 w-12 items-center justify-center rounded-full border border-[#B27C00]">
              <svg
                onClick={() => {
                  my_swiper?.slidePrev();
      ...
      >
        ...
        ></p>
        <Link
          href={`/news/social-media/${activeNews?.id}`}
