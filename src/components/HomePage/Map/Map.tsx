...
const RecenterAutomatically = ({lat, lng, refrence,sideMap}: { lat: number; lng: number, refrence: any ,sideMap:any}) => {
    const map = useMap();
          ...
          >
            {labelTitle}
                ...
                >
                    ...
                    <RecenterAutomatically sideMap={props.sideMap} refrence={props.refrence} lat={boundes?.lat} lng={boundes?.lng}/>
                </MapContainer>
            </section>
        </>
    );
