        ...
        <>
            <main className={`w-full`}>
                ...
                <section className={`w-full bg-blue-04 bg-opacity-10 pt-[5rem] lg:pt-[8rem] pb-14`}>
                    <ProfileLayout>
                        {
                            searchParams.get('tab') && (<Fragment>
                                {searchParams.get('tab') === 'info' &&
                                    <form className={`flex flex-col w-full lg:w-auto gap-4 lg:ms-[148px]`}>
                                        <div className={`w-full flex items-center gap-2 lg:hidden`}>
                                            <ArrowRightIcon onClick={() => router.push('/profile')}
                                                            className={`w-6 h-6 text-gray-03 cursor-pointer`}/>
                                            <h4 className={`text-[20px] text-write-main font-[600]`}>اطلاعات حساب
                                                کاربری</h4>
                                        </div>
                                        <h4 className={`text-[20px] text-write-main font-[400]`}>برای تکمیل حساب کاربری خود
                                            لطفا
                                            موارد
                                            زیر رو کامل کنید.</h4>
                                        <input
                                            ...
                                            className={`w-full lg:w-[439px] h-[56px] rounded-[16px] bg-white text-write-main placeholder:text-gray-03 py-4 px-6 text-[16px] font-[400]`}
                                        />
                                        <input
                                            type={'text'}
                                        ...
                                        />
                                        <button
                                            className={`w-full lg:w-[439px] h-[56px] rounded-[16px] bg-yellow-main text-write-main placeholder:text-gray-03 flex items-center justify-center py-4 px-6 text-[16px] font-[400]`}>
                                            ثبت
                                        </button>
                                    </form>}
                                {searchParams.get('tab') === 'your-introduction' && <Fragment>
                                    <div className={`w-full flex items-center gap-2 lg:hidden`}>
                                        <ArrowRightIcon onClick={() => router.push('/profile')}
                                                        className={`w-6 h-6 text-gray-03 cursor-pointer`}/>
                                        <h4 className={`text-[20px] text-write-main font-[600]`}>
                                            معرفی های شما
                                        </h4>
                                    </div>
                                    <div
                                        onScroll={onScroll}
                                        ref={containerRef}
                                        className="w-full lg:w-auto max-w-[1243px] overflow-hidden overflow-y-auto h-[556px] lg:h-[1288px] lg:pt-8 lg:ms-6"
                                    >
                                        <div
                                                    ...
                                                    <Fragment>
                                                        ...
                                                        <span
                                                            className={`text-[14px] lg:text-[24px] font-[700]`}>{item?.name}</span>
                                                                ...
                                                                <span
                                                                    className={`text-[12px] text-ellipsis leading-6 lg:text-[16px] max-w-full lg:max-w-none text-write-main font-[500]`}>
                                                                {item?.address}
                                                              </span>
                                                                <p
                                ...
                                {searchParams.get('tab') === 'my-bookmarks' && <Fragment>
                                    <div className={`w-full flex items-center gap-2 lg:hidden`}>
                                        <ArrowRightIcon onClick={() => router.push('/profile')}
                                                        className={`w-6 h-6 text-gray-03 cursor-pointer`}/>
                                        <h4 className={`text-[20px] text-write-main font-[600]`}>
                              ...
                              {item?.score}
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <ChatBubbleLeftIcon
                                                                                className={`w-5 h-5 text-gray-04`}/>
                                                                            <span
