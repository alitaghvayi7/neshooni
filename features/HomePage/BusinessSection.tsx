        ...
        <>
            <section className={`flex flex-col items-center w-full max-w-[1689px] mx-auto mt-[11rem] lg:mt-[15rem] gap-8`}>
                <div className={`w-[calc(100%-56px)] lg:w-[calc(100%-128px)] flex items-center justify-between`}>
                    ...
                    <Link href={''} style={{backgroundClip: "content-box", borderRadius: '0 0 0 32px'}}
                          className={`w-fit hidden lg:flex px-6 pb-4 border-b border-l border-yellow-04 bg-transparent text-[12px] lg:text-[16px] text-write-04`}>مشاهده
                        همه</Link>
                </div>
                ...
                <Link href={''} style={{backgroundClip: "content-box", borderRadius: '0 0 0 32px'}}
                      className={`w-fit flex lg:hidden px-6 py-1 border-b border-l border-yellow-04 bg-transparent text-[12px] text-write-04`}>مشاهده
                    همه</Link>
            </section>
        </>
    )
